...
const CatedoryTabs = props => {
  ...
  }, skills.map(skill => /*#__PURE__*/_react.default.createElement("button", {
    key: skill.id,
    type: "button",
    className: _stylesModule.default.tabsButton,
    onClick: onClick
  }, skill.title)), customSkills && /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    className: _stylesModule.default.tabsButton,
    onClick: onClick
  }, "\u0423\u043D\u0438\u043A\u0430\u043B\u044C\u043D\u044B\u0435 \u0443\u0441\u043B\u0443\u0433\u0438")));
...
var _default = exports.default = CatedoryTabs;