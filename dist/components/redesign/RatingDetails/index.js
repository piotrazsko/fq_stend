...
const RatingDetails = _ref => {
  ...
  const ratingValue = Math.ceil((rating[5] * 5 + rating[4] * 4 + rating[3] * 3 + rating[2] * 2 + rating[1] * 1) * 10 / count) / 10;
...
var _default = exports.default = RatingDetails;